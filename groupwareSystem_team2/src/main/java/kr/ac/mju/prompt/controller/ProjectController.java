...
public class ProjectController {
	...
	@RequestMapping(value = "/ProjectController/project.do", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/ProjectController/signup", method = RequestMethod.POST) // 비개발자
																					// 등록
	...
	@RequestMapping(value = "/ProjectController/signup_developer", method = RequestMethod.POST) // 개발자
																								// 등록
