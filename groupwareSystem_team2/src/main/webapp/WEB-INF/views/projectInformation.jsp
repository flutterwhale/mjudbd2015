		...
		<form name="frm1"
			...
			<div class="project_information">
				...
				<table class="table table-striped table-hover" width="920px">
					...
					<tr>
						<th>PM</th>
						<td><a href="http://localhost:8080/mju/LoginController/retrieveUser?id=<%=pBean.getProjectmanager_Identifier()%>"><%=pBean.getProjectmanager_Identifier()%></a>/<%=pBean.getPM_name()%></td>
					</tr>
				</table>
