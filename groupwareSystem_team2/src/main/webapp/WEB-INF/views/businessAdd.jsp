...
<title>업무 일지 추가</title>
<script
	src="http://ajax.googleapis.com/ajax/libs/jquery/1.6.4/jquery.min.js"
	type="text/javascript"></script>
</head>
<body>
	<div class="business_Add_Wrapper">
		<div class="business_Add">
			<table class="business_Add_table" border="1" width="600px">
				<tr>
	...
	<div class="main_button">
		...
		<button type="submit"
			onclick="location.href='${pageContext.request.contextPath}/ProjectController/showBusinessLog'">등록
		</button>
	</div>
</body>
</html>