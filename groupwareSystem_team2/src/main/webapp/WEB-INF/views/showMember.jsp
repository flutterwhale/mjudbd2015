...
<body>
	...
	<nav class="navbar navbar-default">
		...
		<form class="form-horizontal" onSubmit="return check()" method="POST" name="myform">
			<fieldset>
		         <legend><label class="col-sm-3 control-label">직원정보<br>(조직도 정보)</label></legend>
	       ...
	       <div class="form-group">
	         ...
	         <legend><label class="col-sm-3 control-label">평가정보</label></legend>
		      	 <div class="form-group  col-sm-4">
	      	<!-- 김용민이 수정하는 부분 2015년 12월 02 일 23시 시작.  -->
			<table id="developer_join" class="table table-striped table-hover" style="width:800px;">
			   <tbody>
			   		<tr>
			        	<th>프로젝트번호</th>
			         	<th>프로젝트내 업무</th>
			...
			%>  	
					<tr>
			        	<td><a
			         	...
			         	<td><%if(eval_list.get(j).get("Project_Role").equals("11")){%><%=eval_list.get(j).get("Evaluation_Contents")%><%}%></td>
			        </tr>
