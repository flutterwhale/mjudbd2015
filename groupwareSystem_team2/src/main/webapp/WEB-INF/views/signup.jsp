...
<body>
		...
		<form class="form-horizontal" onSubmit="return check()" action="${pageContext.request.contextPath}/LoginController/signup" method="POST" name="myform">
			<fieldset>
		         ...
		         <div class="form-group">
		            <label for="inputname" class="col-sm-4 control-label" class="text-right">emal</label>
		             <div class="col-sm-6">
