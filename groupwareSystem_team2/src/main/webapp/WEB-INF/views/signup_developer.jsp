      ...
      <form class="form-horizontal" onSubmit="return check()"
         ...
         <div class="form-group">
            <label for="inputname" class="col-sm-2 control-label">최종학력</label>
             <div class="col-sm-10">
                  <input id="university" class="form-control" style="width:200px;"
                   type="text" name="university" size="10" maxlength="10">학교 <input id="major"
                    class="form-control" style="width:200px;" type="text" name="major"
                     size="10" maxlength="10">학과 <input id="entrance" class="form-control"
                      style="width:200px;" type="text" name="entrance" size="10"
                       maxlength="10">입학<input id="graduation" class="form-control"
                       style="width:200px;" type="text" name="graduation" size="10" maxlength="10">졸업
             </div>
          </div>
          <div class="form-group">
         ...
         <div class="form-group">
            <label for="inputname" class="col-sm-2 control-label">프리랜서 여부</label>
            <div class="col-sm-10">
               <input type="checkbox" name="isFreelancer" value="FreeLancer" >
            </div>
         </div>
         <div class="form-group">
          ...
          <div class="form-group">
             <label for="inputname" class="col-sm-2 control-label">기술 등급</label>
             <label class="radio-inline">
            <input type="radio" value="10" name="tech_level" id="inlineRadio1"> 고급</label>
            <label class="radio-inline">
            <input type="radio" value="20" name="tech_level" id="inlineRadio2"> 중급</label>
            <label class="radio-inline">
            <input type="radio" value="30" name="tech_level" id="inlineRadio3"> 하급</label>
          </div>
         <div class="form-group">
            <label for="inputname" class="col-sm-2 control-label">사용 가능 언어</label>
            <input type="text" id="language" name="language">
            <label class="radio-inline">
            <input type="radio" value="10" name="language_level" id="inlineRadio1"> 상</label>
            <label class="radio-inline">
            <input type="radio" value="20" name="language_level" id="inlineRadio2"> 중</label>
            <label class="radio-inline">
            <input type="radio" value="30" name="language_level" id="inlineRadio3"> 하</label>
         </div>
         </fieldset>
