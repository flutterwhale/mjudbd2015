	...
	<table id="developer_join" border="1">
		...
		<tr>
			...
			<td colspan="2">
				...
				<input id="major" type="text" name="major" size="10" maxlength="10">학과(부) 
				<input id="entrance" type="text" name="entrance" size="10" maxlength="10">전공
		...
		<tr>
			<td>프리랜서 여부</td>
			<td colspan="2"><input type="checkbox" name="isFreelancer" value="FreeLancer"></td>
		</tr>
		<tr>
			<td>포트폴리오 업로드</td>
		...
		<tr>
			<td colspan="3"><button id="addItemBtn" onclick="return false;">개발 가능 언어 추가</button></td>
		</tr>
		<tr class="item1">
		...
		<tr class="item2">
			<td>
				<select id="select2" name="select2" onchange="langugeEtc(this.value,this)">
                    <option value="C" >C</option>
                    <option value="C++" >C++</option>
                    <option value="JSP" >JSP</option>
                    <option value="PHP" >PHP</option>
               	...
               	<input type="text" id="language2" name="language2" value="C" style="visibility:hidden;" size="1" />
				<label><input type="radio" value="10" name="language_level2">상</label> 
				<label><input type="radio" value="20" name="language_level2">중</label>
				<label><input type="radio" value="30" name="language_level2">하</label>
			</td>
